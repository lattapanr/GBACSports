  ...
  return (
    <div className="text-black w-full max-w-screen-laptop h-full lg:h-full mx-auto">
      <div className="w-10/12 lg:w-full mx-auto flex flex-col">
        <h1 className="lg:text-lg pt-32 lg:pt-12 pb-2">
          Click <Link className="underline">here</Link> for GBAC Season 1 24/25
          basketball league fixtures & results
        </h1>
        ...
        <img
          ...
          alt="GBAC's U19 boys lining up on a football field"
