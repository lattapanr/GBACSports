...
const AgeGroupsPage = () => {
  return (
    <div className="mt-[100px] md:mt-[50px] lg:mt-0 min-h-screen mx-auto overflow-y-scroll relative bg-white backdrop-filter bg-opacity-90">
      <Helmet>
  <title>Age Groups | GBAC Sports</title>
  <meta name="description" content="Learn about the age group divisions in the Greater Bangkok Athletics Conference (GBAC). Discover how student-athletes are organized by age categories to ensure fair and competitive inter-school sports events across Bangkok." />
</Helmet>
      ...
      <div className="relative z-10 lg:max-w-full mx-auto min-h-screen flex flex-col items-center justify-center text-sm md:text-md lg:text-base font-extralight">
        <div className="p-4 sm:p-10 md:p-16">
          <motion.h1
            ...
            className="text-4xl w-full md:text-5xl lg:text-6xl leading-8 self-center mb-4 font-extrabold border-b-2 lg:border-b-4 border-black pb-2"
          >
            GBAC Age Groups
          </motion.h1>
          <motion.p
            ...
            className="mb-6 md:text-base font-light"
          >
      ...
      <div className="relative z-10 max-w-[90%]  md:max-w-full mx-auto min-h-screen flex flex-col items-center justify-center text-sm md:text-md lg:text-base font-light  p-4 sm:p-10 md:p-16">
        <div className="sm:p-10 md:p-16">
          ...
          <motion.div
            ...
            className="w-full md:pl-5 max-w-[350px] mx-auto"
          >
            <AgeCalculator />
          </motion.div>
          <motion.p
