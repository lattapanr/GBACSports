...
const schoolData = [
  {
    ...
    address: "304/1 Thanon Si Ayutthaya, Thung Phaya Thai, Ratchathewi, Bangkok 10400",
    contact: "Director of Sport & GBAC Committee Member - Oliver Parkinson (oliverp@amnuaysilpa.ac.th)",
...
Bang Kapi District, Bangkok 10240`,
        contact: (
          <>
            ...
            <br />
            Head of Football & GBAC Vice Chairman - Richard Hudson (rhudson@brightoncollege.ac.th)
          </>
        ),
        phone: "+66 (0) 2136 7898",
        website: "https://brightoncollegebangkok.com/?gad_source=1&gclid=Cj0KCQjwsoe5BhDiARIsAOXVoUsC_j_1tN8WIgwSJMqt__qXaiujACG2LEOhfXnO2rNvYpN8czbwOEQaArPhEALw_wcB",
        image: BCBGround,
...
Khet Bang Na, Krung Thep Maha Nakhon 10260`,
    ...
    },
    {
        ...
        address: (
          <>
            <span className="font-semibold">Senior Campus</span> (All TSIS GBAC fixtures are hosted here)
            <br />
...
GBAC Committee Member`,
        address: "18 Krung Thep Kritha Rd, Khwaeng Saphan Sung, Khet Saphan Sung, Krung Thep Maha Nakhon 10250",
      ...
      <div className="mx-auto max-w-screen-laptop pt-[83px] md:pt-[73px] lg:pt-0">
        {schoolData.map((school, index) => (
          ...
          >
            ...
            <div className="w-full md:w-1/2 p-4 md:content-center">
              ...
              {school.map && <a href={school.map} className="underline">School Location</a>}
            </div>
          </div>
        ))}
      </div>
